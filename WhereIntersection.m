function [] = WhereIntersection(Datasheet1_struct,Datasheet2_struct, Datasheet3_struct, Datasheet4_struct, Datasheet5_struct, WhattoplotStr)
...
tit= [WhattoplotStr, ' - Plot to check where is intersection'];
title(tit);
ylabel('Attitude [deg]');
xlabel('Time [s]');
legend('1', '2', '3', '4', '5');
